...
jQuery("span").filter(function() { return jQuery(this).text().indexOf("[") >= 0 }).css('border', 'solid 4px red !important');
jQuery("span").filter(function() { return jQuery(this).text().indexOf("[") >= 0 }).css('margin-bottom:', '5px !important');
