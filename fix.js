...
var $test = $('pre').html();
$test = $test.replace(/\[Intro]/gi, '<br/><p style="margin-bottom:-5px;margin-left:-10px;"><span class="replaced">Intro</span></p>');
$test = $test.replace(/\[Chorus]/gi, '<br/><p style="margin-bottom:-5px;margin-left:-10px;"><span class="replaced">Chorus</span></p>');
...
$test = $test.replace(/\[Interlude]/gi, '<br/><p style="margin-bottom:-5px;margin-left:-10px;"><span class="replaced">Interlude</span></p>');
...
$test = $test.replace(/Capo fret 7/gi, '<p style="margin-bottom:-5px;margin-left:-10px;"><span class="replaced">Capo fret 7</span></p>');
$test = $test.replace(/Capo fret 8/gi, '<p style="margin-bottom:-5px;margin-left:-10px;"><span class="replaced">Capo fret 8</span></p>');
$test = $test.replace(/\[Drop]/gi, '<p style="margin-bottom:-5px;margin-left:-10px;"><span class="replaced">Drop</span></p>');
$('pre').html($test);
}, 3000);
